 const people = [
  ...
  console.log("filter是全部查找");
  console.log(comment);
  console.log("find是找第一个");
  console.log(comment2);

  // 3. 符合ID的第一个人员的位置
  // findIndex()方法返回数组中满足提供的测试函数的第一个元素的索引。若没有找到对应元素则返回-1。
  console.log("符合ID:823423的第一个人员的位置");
